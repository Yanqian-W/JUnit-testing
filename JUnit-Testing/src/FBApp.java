...
public class FBApp {
    ...
    public static void AddFootballPlayer() {
        ...
        // Add a judgment on whether the ID is valid.
        // If ID less than 1, it will enter the next cycle.
        // Avoid throwing an IndexOutOfBoundsException
    ...
    public static void SetTeamMember() {
        ...
        int memberNumber = in.nextInt();//modified by Lewei Jiang, 20412245,biylj9
        //if not memberNumber=in.nextInt()-1, then the number input will not equal the players added to each team
        System.out.print("Which member to team1?: ");
        //for (int j = 0; j < memberNumber; j++){//modified by Lewei Jiang, 20412245,biylj9
        for (int j = 0; j <= memberNumber-1; j++){
